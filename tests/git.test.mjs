...
import { collectReviewContext, resolveReviewTarget } from "../plugins/code-review/scripts/lib/git.mjs";
...
test("collectReviewContext skips broken untracked symlinks instead of crashing", (t) => {
  if (process.platform === "win32") {
    t.skip("Git for Windows does not report a broken junction, and file symlinks require Developer Mode.");
    return;
  }
  const cwd = makeTempDir();
  initGitRepo(cwd);
